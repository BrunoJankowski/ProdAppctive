...
itemNotes.innerHTML = localStorage.getItem('pl-notes')



for(var i = 0; i<itemGoal.length; i++){
    var goal = itemGoal[i]
    var initial_goal = localStorage.getItem('hours_goal_polish')
    ...
    goal.addEventListener('change', function(event) {
        ...
        localStorage.setItem('hours_goal_polish', item_goal)
      })
}
...
for(var i = 0; i < itemButton.length; i++){
    ...
    var initial_hours = localStorage.getItem('hours_worked_polish')
    ...
    button.addEventListener("click", function(event){
        ...
        hours_worked.value++ 
        localStorage.setItem('hours_worked_polish', hours_worked.value)
    ...
    reset.addEventListener("click", function(event){
        ...
        reset_hours.value = 0
        localStorage.setItem('hours_worked_polish', 0)
