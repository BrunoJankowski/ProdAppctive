...
itemNotesReset.addEventListener('click', function(){
    itemNotes.innerText = '...'
    localStorage.setItem('eng-notes', '')
    location.reload
})

itemNotes.innerHTML = localStorage.getItem('eng-notes')
...
for(var i = 0; i < itemButton.length; i++){
    ...
    button.addEventListener("click", function(event){
        ...
        hours_worked.value++ 
        localStorage.setItem('hours_worked_english', hours_worked.value)
    ...
    reset.addEventListener("click", function(event){
        ...
        reset_hours.value = 0
        localStorage.setItem('hours_worked_english', 0)
